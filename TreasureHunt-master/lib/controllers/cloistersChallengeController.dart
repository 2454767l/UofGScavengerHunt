...
class CloistersChallengeController extends GetxController
  ...
  final List<TaskQuestion>? tasksList = cloistersChallengeTaskData
  ...
  void goToNextTask() {
    if (taskNumberVar.value == 5) {
      Get.to(OurCloistersChallengeResultsPage());
      /*Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) =>
