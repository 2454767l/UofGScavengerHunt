...
class OurStevensonChallengeResultsPage extends StatelessWidget {
  const OurStevensonChallengeResultsPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    StevensonChallengeController _qnController = Get.put(StevensonChallengeController());
    ...
    void _updateTreasureAndGoHome(BuildContext context) async {
      ...
      await OurDatabase().updateStevensonChallengeCompletionStatus(_firebaseUser.uid);
          ...
          child: Column(
            children: [
              ...
              const Padding(
                padding: EdgeInsets.all(standardPadding / 2),
                child: Text(
                  "You Have Completed the Stevenson Sports Challenge",
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      color: goldenText,
                      fontSize: 16),
