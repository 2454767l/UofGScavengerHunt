...
class CloistersPopUpCard extends StatelessWidget {
  const CloistersPopUpCard({
    Key? key,
  }) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 25),
              Text(
                'You have entered the radius of the Cloisters Challenge...',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
              ...
              ElevatedButton(
                ...
                onPressed: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                      const OurCloistersChallengeWelcome()),
                ),
                style: ButtonStyle(
